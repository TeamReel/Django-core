...
- karate_kick: Player AIRBORNE performing a flying karate kick — BOTH FEET OFF THE GROUND, fully suspended in mid-air. The kicking leg is fully extended forward in a powerful straight martial-arts kick (tobi mae geri / flying front kick). The other leg is tucked or trailing behind. Arms out for balance. The ball MUST be visible ALREADY FLYING AWAY from the foot — it has just been struck with tremendous force. The player has a FIERCE, DETERMINED expression (verbeten blik) — gritted teeth, intense eyes, warrior face. NOT a volley, NOT a bicycle kick. Think flying karate kick from a martial arts movie applied to football. Explosive, airborne, aggressive.
