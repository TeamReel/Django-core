...
Jij: "build module B62"
  │
  ├─ Gate 0: Discovery
  │   ├─ Leest de spec uit documents/02-roadmap/modules/ready/ (of active/)
...
| Probleem | Oplossing |
|---------|----------|
| "Spec niet gevonden" | Check of de folder in `documents/02-roadmap/modules/ready/` of `active/` staat |
