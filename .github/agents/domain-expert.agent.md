...
tools:
  [read/readFile, read/problems, search/codebase, search/textSearch, search/fileSearch, search/listDirectory, search/changes, search/usages, agent/runSubagent, todo]
agents:
  - developer
  - planner
handoffs:
