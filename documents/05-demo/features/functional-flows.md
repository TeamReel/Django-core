...
For technical architecture, see [architecture.md](../architecture.md). For API details, see [api-reference.md](api-reference.md).
...
> **Implementation:** React app with `react-router-dom`, context-switcher package. See [ux-flows.md](../frontend-design/ux-flows.md).
...
> For the complete 67-model schema, see [architecture.md](../architecture.md) and [tables.md](../data/tables.md).
