...
**Status:** 🔴 In Progress (7/12 fases done)
...
| Inline `style={{...}}` | ~~214~~ **73** in components (0 static, 69 dynamic, 4 test) | <30 |
...
| **S2** | Page Styles | 118 inline styles in `pages/` → CSS Modules | <20 inline | 8 uur |
