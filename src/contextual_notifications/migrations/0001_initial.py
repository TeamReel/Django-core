...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_enabled",
                    models.BooleanField(
                        db_index=True, default=True, help_text="Whether this rule is active"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quiet_hours_enabled",
                    models.BooleanField(
                        default=False, help_text="Enable quiet hours rate limiting"
                    ),
                ),
                (
                    "quiet_hours_start",
                    models.TimeField(
                        blank=True, help_text="Quiet hours start time (e.g., 22:00)", null=True
                    ),
                ),
                (
                    "quiet_hours_end",
                    models.TimeField(
                        blank=True, help_text="Quiet hours end time (e.g., 08:00)", null=True
                    ),
                ),
                (
                ...
                (
                    ...
                    models.IntegerField(
                        default=10, help_text="Max notifications per minute during quiet hours"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["event_type", "organisation"], name="contextual_routing_ev_event_t_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="routingrule",
            index=models.Index(
                fields=["event_type", "scope"], name="contextual_routing_ev_event_s_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="contextual_notific_user_id_event_t_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationpreference",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("quiet_hours_enabled", False))
                | models.Q(
