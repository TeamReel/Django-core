...
class TestUsageEventAPI:
    ...
    def test_create_usage_event_success(self, user, organisation, project):
    ...
    def test_create_usage_event_duplicate_idempotency_key(self, user, organisation):
    ...
    def test_create_usage_event_validation_error(self, user, organisation):
    ...
    def test_create_usage_event_project_org_mismatch(self, user, organisation, project):
    ...
    def test_list_usage_events(self, user, organisation, project):
...
class TestTransactionAPI:
    ...
    def test_create_transaction_success(self, user, organisation):
    ...
    def test_create_transaction_duplicate_idempotency_key(self, user, organisation):
    ...
    def test_create_transaction_insufficient_balance(self, user, organisation):
    ...
    def test_create_transaction_validation_error_zero_amount(self, user, organisation):
    ...
    def test_list_transactions(self, user, organisation):
...
class TestBalanceAPI:
    ...
    def test_get_organization_balance(self, user, organisation):
    ...
    def test_get_project_balance(self, user, organisation, project):
...
class TestBalancePolicyAPI:
    ...
    def test_get_policy_by_organization(self, organisation):
    ...
    def test_get_policy_by_project(self, organisation, project):
    ...
    def test_get_policy_returns_default_if_not_found(self, organisation):
    ...
    def test_update_policy(self, organisation):
...
class TestMultiTenantIsolation:
    ...
    def test_transaction_creation_enforces_org_project_match(self, user, organisation, project):
