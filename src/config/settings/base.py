...
MIDDLEWARE = [
    ...
    "src.i18n_preferences.middleware.PreferenceLocaleMiddleware",  # B12: User/org language activation
    "src.i18n_preferences.middleware.PreferenceTimezoneMiddleware",  # B12: User/org timezone activation
