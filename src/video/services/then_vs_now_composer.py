...
def _minimax_generate_video(
    ...
    prompt = (
        ...
        "on a football pitch. "
        "BODIES ARE PERFECTLY STILL like statues from the neck down. "
        "No leaning, no swaying, no shoulder movement. "
        "THE MAIN ACTION: Both players MUST slowly turn their FACES to look at each other. "
        "This is the entire point of the video. "
        "ONLY the faces rotate slowly on their necks — HORIZONTAL rotation only "
        "(yaw, left-right like saying no). "
        "Left person's face turns slowly to the right, "
        "right person's face turns slowly to the left "
        "— they look sideways at each other and smile. "
        ...
        "The ONLY movement is the faces rotating slowly. Bodies frozen. "
        "No special effects, no blur, no glow, no particles, no filters. "
        "Photorealistic — like a real camera recording. "
