  ...
  return (
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }} data-testid="context-switcher-page">
      <div style={{ padding: '24px', borderBottom: '1px solid #e5e5e5', backgroundColor: '#fff' }}>
        ...
        <p style={{ margin: 0, fontSize: '14px', color: '#6b7280' }}>F03 Multi-Tenancy Context Demo</p>
      </div>
      <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
        <Card style={{ padding: '24px', marginBottom: '24px' }}>
          <h3 style={{ margin: '0 0 16px 0' }}>Current Context</h3>
          <div style={{ marginBottom: '12px' }}>
            <p style={{ margin: '0 0 4px 0', color: '#6b7280' }}>Organization</p>
            <Badge variant="primary">ACME Corp</Badge>
          </div>
          <div>
            <p style={{ margin: '0 0 4px 0', color: '#6b7280' }}>Project</p>
        ...
        <Card style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px' }}>
            {['ACME Corp', 'TechStart Inc', 'Global Solutions'].map((org) => (
              <div key={org} style={{ border: '1px solid #e5e5e5', borderRadius: '8px', padding: '12px' }}>
                <p style={{ margin: 0, fontWeight: 600 }}>{org}</p>
                <p style={{ margin: '4px 0 0 0', fontSize: '12px', color: '#6b7280' }}>3 projects</p>
              </div>
            ))}
          </div>
        </Card>
