...
/** Simple inline Toast for demo — replaces @django-core/notifications-hub dependency. */
function Toast({ notification, onDismiss, variant }: { notification: any; onDismiss: (id: string) => void; variant?: string }) {
