...
export function usePreferencesData(): PreferencesDataReturn {
  ...
  const organisationLabelByKey = useMemo(() => {
    ...
    const userOrgs: Record<string, unknown>[] = Array.isArray((user as Record<string, unknown> | null)?.organisations) ? (user as Record<string, unknown>).organisations as Record<string, unknown>[] : [];
  ...
  const projectLabelByKey = useMemo(() => {
    const map = new Map<string, string>();
    const userProjects: Record<string, unknown>[] = Array.isArray((user as Record<string, unknown> | null)?.projects) ? (user as Record<string, unknown>).projects as Record<string, unknown>[] : [];
