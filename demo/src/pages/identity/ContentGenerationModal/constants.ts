...
export const CONTENT_TYPES = {
  pre_match: {
    ...
    sportRequired: true,
    items: [
      { id: 'flyer', label: 'Wedstrijd Flyer', icon: 'MF', subtype: 'flyer', enabled: true },
      { id: 'lineup', label: 'Lineup Video', icon: 'LV', subtype: 'lineup', enabled: true },
      { id: 'lineup_flyer', label: 'Lineup Flyer', icon: 'LF', subtype: 'lineup_flyer', enabled: true },
      { id: 'match_intro', label: 'Wedstrijd Intro', icon: 'MI', subtype: 'match_intro', enabled: true },
      { id: 'poster', label: 'Elftalfoto', icon: 'EF', subtype: 'poster', enabled: true },
      { id: 'walkon', label: 'Walk-on Video', icon: 'WO', subtype: 'walkon', enabled: false },
      { id: 'anthem', label: 'Anthem Video', icon: 'AV', subtype: 'anthem', enabled: false },
    ],
  },
  during_match: {
  ...
  post_match: {
    ...
    sportRequired: true,
    items: [
      { id: 'end_score', label: 'Eindstand', icon: 'FS', subtype: 'end_score', enabled: false },
      { id: 'match_summary', label: 'Wedstrijd Samenvatting', icon: 'MS', subtype: 'match_summary', enabled: true },
      { id: 'highlights', label: 'Hoogtepunten', icon: 'HR', subtype: 'highlights', enabled: false },
    ],
  },
  season: {
    label: 'Seizoen',
