...
export function useTopNavbarData(onOpenSearchRef?: (fn: () => void) => void): UseTopNavbarDataReturn {
  ...
  useTopNavbarEffects({
    ...
    closeTimerRef: state.closeTimerRef,
    onOpenSearchRef,
    setCommandOpen: state.setCommandOpen,
    setOpenDropdown: state.setOpenDropdown,
  ...
  const handlers = useTopNavbarHandlers({
    ...
    closeTimerRef: state.closeTimerRef,
    isDropdownHoveredRef: state.isDropdownHoveredRef,
  ...
  return {
    ...
    openDropdown: state.openDropdown,
    setOpenDropdown: state.setOpenDropdown,
    filteredNavGroups: derived.filteredNavGroups,
    dashboardItem: derived.dashboardItem,
    isItemActive: derived.isItemActive,
    isGroupActive: derived.isGroupActive,
    handleMouseEnterTrigger: handlers.handleMouseEnterTrigger,
    handleMouseLeaveTrigger: handlers.handleMouseLeaveTrigger,
    handleMouseEnterDropdown: handlers.handleMouseEnterDropdown,
    handleMouseLeaveDropdown: handlers.handleMouseLeaveDropdown,
    handleClickTrigger: handlers.handleClickTrigger,
