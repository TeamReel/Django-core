...
export function useTopNavbarEffects(params: UseTopNavbarEffectsParams) {
  const {
    user, location, orgIdForMyBalance, languageMenuOpen,
    createMenuOpen, createMenuRef, onOpenSearchRef,
    setCommandOpen, setLanguage,
    setLanguageMenuOpen, setUnreadCount, setNotificationsList,
    setMyCreditsBalance, setCreateMenuOpen,
  } = params;
