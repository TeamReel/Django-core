...
import {
  ...
  Bell, CreditCard, UserCircle, Star, Calendar, Film, Fingerprint, Scissors,
  ClipboardCheck, GitBranch, Video, Image, Footprints, Camera, UsersRound, Zap
} from 'lucide-react';
...
export function useSidebarData() {
    ...
    // ── Panel A: show detail/context links under APP ──────────────────
    ...
    // ── Return everything the Sidebar JSX needs ───────────────────────
    return {
        // Role / auth
        isSystemAdmin,
        isOrgAdmin,
