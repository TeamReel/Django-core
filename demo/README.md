# Django Core Demo Application

**Purpose**: Production-ready **reference implementation** that showcases all F01-F09 frontend packages and B01-B24 backend modules. Serves three roles:

1. **Living Documentation** — See every module in action
2. **Integration Smoke Test** — Validates all modules work together
3. **Reference Architecture** — Example patterns for product development

**NOT a Starting Template**: When building your product, start fresh with scaffolding CLI (B20) and import core modules as dependencies. Demo stays clean as showcase.

**Module**: F10 Demo Shell
**Location**: `/demo` (root level)
...
**Demo is reference only.** For actual product development:

### Pattern: Core as Foundation

```bash
# 1. Scaffold new product (outside django-core repo)
django-admin startproject --template=core-app your-product
cd your-product

# 2. Install core modules as dependencies
pip install django-core-auth django-core-api  # Backend
pnpm add @django-core/design-system @django-core/auth  # Frontend

# 3. Build your 20% custom logic
# - Use patterns from /demo as reference
# - Copy examples from /examples as needed
# - Import core modules, don't fork
```

### Why Separate?

- ✅ **Core stays clean** — No product-specific code polluting foundation
- ✅ **Demo stays relevant** — Always showcases latest core capabilities
- ✅ **Updates are easy** — `pnpm update` gets core improvements
- ✅ **Multiple products possible** — E-commerce, CRM, etc. share same core

**Analogy**: Django provides testproject for demo, you run `startproject` for your app. Same pattern here.
