...
## Checklist
- [x] Fix response in `src/files/views.py` — include rejected paths as `None`
- [x] Test: `pytest tests/files/test_presigned_urls.py -x`
- [x] Verify: `pytest -x` — full suite passes
