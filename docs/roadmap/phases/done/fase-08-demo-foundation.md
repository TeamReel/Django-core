...
## 31. F10 – Demo Shell (Basic)

**Doel**: Minimale reference applicatie die F01-F09 frontend packages en B05-B18 backend APIs end-to-end exercised. Living integration smoke test voor core platform contracts.
...
**Demo**: 🚀 Live at `http://localhost:3000` (na `pnpm dev` in `examples/demo-shell/`)

---

## 32. F10b-Database – Demo Production Database & Seed Data

**Doel**: Production-ready database setup + comprehensive seed data voor volledig werkende demo app die **alle modules 001-030 demonstreert**.
...
**Doel**: 30+ fully functional demo pages die **alle geïmplementeerde modules** (B01-B21, F01-F09) demonstreren met echte backend integratie.
...
- **Confidence building**: proof dat platform compleet werkt
...
**Routing** (`examples/demo-shell/src/App.tsx`):
```typescript
<Routes>
...
**Testing** (`examples/demo-shell/tests/e2e/`):
...
**Timing**: Na Fase 8 (modules 031-033 compleet)
...
**Fase 8 Compleet**: 3 modules (F10, F10b-Database, F10b-Pages)
**Volgende**: Fase 9 - Backend Infrastructure (B22-B25)
