...
- [x] **T011** → T001-T007 | Create `src/main.tsx` (React root, providers setup) ✅ COMPLETE (WP02)
- [x] **T012** [P] Create `src/App.tsx` (React Router setup, route definitions) ✅ COMPLETE (WP02)
- [x] **T013** [P] Create `src/pages/LoginPage.tsx` (login form, F02 AuthProvider integration) ✅ COMPLETE (WP02)
- [x] **T014** [P] Create `src/pages/DashboardPage.tsx` (authenticated landing, shows username) ✅ COMPLETE (WP02)
- [x] **T015** [P] Create `src/index.css` (global styles) ✅ COMPLETE (WP02)
- [ ] **T016** [DEFERRED to WP08] Create `src/lib/api-client.ts` (fetch wrapper with CSRF token handling)
- [ ] **T017** [DEFERRED to WP08] Create `src/components/ErrorBoundary.tsx` (error boundary component)
